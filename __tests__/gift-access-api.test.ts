...
jest.mock("../src/server/gifts/repository", () => ({ getGiftSessionEmail: jest.fn(async () => "viewer@example.com"), getGiftAccessByTokenHash: jest.fn(async () => ({ id: "gift-1", status: "bound", role: "viewer", albumId: "album-1", albumTitle: "A shared trip", publishedAt: "2026-07-24T00:00:00.000Z", version: 1 })) }));
