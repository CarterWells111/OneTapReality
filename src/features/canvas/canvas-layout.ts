...
import { bodyFontFamily, displayFontFamily } from "../typography/fonts";
...
export function createLegacyLayout(page: Omit<StoryPage, "layout">): CanvasLayout {
  ...
  elements.push(
    { id: `${page.id}:headline`, type: "text", text: page.headline, fontStyle: displayFontFamily, color: "#24312B", fontSize: 22, x: 0.1, y: page.photoUri ? 0.62 : 0.24, width: 0.8, height: 0.12, rotation: 0, zIndex: 2 },
