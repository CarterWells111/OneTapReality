    ...
    <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.content}>
      ...
      <Section title="账户与 NFC 礼品共享">
        <PrivacyCard title="只在明确发布时上传">
          你可以使用邮箱验证码登录。礼品拥有者或受邀的可编辑成员只有主动发布共享版本时，才会上传共享快照和该版本所选的照片副本；发布不会自动上传或修改设备上的本地原件。
        </PrivacyCard>
        <PrivacyCard title="共享角色与邮箱邀请">
          礼品拥有者可邀请只读成员或可编辑成员，并可随时切换权限。受邀成员使用匹配邀请邮箱的账号登录即可查看完整相册，无需接触实体礼品。
        </PrivacyCard>
